...
./test-b/listsort-O2.exe:     file format elf32-i386
...
08048470 <main>:
 ...
 80484f0:	89 45 e8             	mov    %eax,0xffffffe8(%ebp)
 80484f3:	8b 5d e8             	mov    0xffffffe8(%ebp),%ebx
 80484f6:	bf 01 00 00 00       	mov    $0x1,%edi
 80484fb:	c7 45 e8 00 00 00 00 	movl   $0x0,0xffffffe8(%ebp)
 8048502:	85 db                	test   %ebx,%ebx
 8048504:	74 54                	je     804855a <main+0xea>
 8048506:	83 ff 01             	cmp    $0x1,%edi
 8048509:	89 d8                	mov    %ebx,%eax
 804850b:	0f 9f 45 df          	setg   0xffffffdf(%ebp)
 804850f:	8d 75 e8             	lea    0xffffffe8(%ebp),%esi
 8048512:	c7 45 d8 00 00 00 00 	movl   $0x0,0xffffffd8(%ebp)
 8048519:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
 8048520:	80 7d df 00          	cmpb   $0x0,0xffffffdf(%ebp)
 8048524:	74 4e                	je     8048574 <main+0x104>
 8048526:	85 c0                	test   %eax,%eax
 8048528:	74 13                	je     804853d <main+0xcd>
 804852a:	ba 01 00 00 00       	mov    $0x1,%edx
 804852f:	83 c2 01             	add    $0x1,%edx
 8048532:	8b 40 04             	mov    0x4(%eax),%eax
 8048535:	39 d7                	cmp    %edx,%edi
 8048537:	7e 3b                	jle    8048574 <main+0x104>
 8048539:	85 c0                	test   %eax,%eax
 804853b:	75 f2                	jne    804852f <main+0xbf>
 804853d:	8b 45 d8             	mov    0xffffffd8(%ebp),%eax
 8048540:	89 1e                	mov    %ebx,(%esi)
 8048542:	85 c0                	test   %eax,%eax
 8048544:	0f 84 c2 00 00 00    	je     804860c <main+0x19c>
 804854a:	8b 5d e8             	mov    0xffffffe8(%ebp),%ebx
 804854d:	01 ff                	add    %edi,%edi
 804854f:	c7 45 e8 00 00 00 00 	movl   $0x0,0xffffffe8(%ebp)
 8048556:	85 db                	test   %ebx,%ebx
 8048558:	75 ac                	jne    8048506 <main+0x96>
 804855a:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
 8048561:	e8 c6 fd ff ff       	call   804832c <putchar@plt>
 8048566:	83 c4 28             	add    $0x28,%esp
 ...
 804856e:	5f                   	pop    %edi
 804856f:	5d                   	pop    %ebp
 8048570:	8d 61 fc             	lea    0xfffffffc(%ecx),%esp
 8048573:	c3                   	ret    
 8048574:	85 c0                	test   %eax,%eax
 8048576:	74 c5                	je     804853d <main+0xcd>
 8048578:	80 7d df 00          	cmpb   $0x0,0xffffffdf(%ebp)
 804857c:	8b 50 04             	mov    0x4(%eax),%edx
 804857f:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 8048586:	74 5a                	je     80485e2 <main+0x172>
 8048588:	85 d2                	test   %edx,%edx
 804858a:	89 d0                	mov    %edx,%eax
 804858c:	b9 01 00 00 00       	mov    $0x1,%ecx
 8048591:	74 4f                	je     80485e2 <main+0x172>
 8048593:	83 c1 01             	add    $0x1,%ecx
 8048596:	8b 40 04             	mov    0x4(%eax),%eax
 8048599:	39 cf                	cmp    %ecx,%edi
 804859b:	7e 47                	jle    80485e4 <main+0x174>
 804859d:	85 c0                	test   %eax,%eax
 804859f:	75 f2                	jne    8048593 <main+0x123>
 80485a1:	31 c9                	xor    %ecx,%ecx
 80485a3:	89 d8                	mov    %ebx,%eax
 80485a5:	85 c0                	test   %eax,%eax
 80485a7:	74 17                	je     80485c0 <main+0x150>
 80485a9:	85 d2                	test   %edx,%edx
 80485ab:	74 47                	je     80485f4 <main+0x184>
 80485ad:	8b 1a                	mov    (%edx),%ebx
 80485af:	39 18                	cmp    %ebx,(%eax)
 80485b1:	78 4f                	js     8048602 <main+0x192>
 80485b3:	85 c0                	test   %eax,%eax
 80485b5:	89 16                	mov    %edx,(%esi)
 80485b7:	8d 72 04             	lea    0x4(%edx),%esi
 80485ba:	8b 52 04             	mov    0x4(%edx),%edx
 80485bd:	75 ea                	jne    80485a9 <main+0x139>
 80485bf:	90                   	nop    
 ...
 80485d5:	0f 84 6f ff ff ff    	je     804854a <main+0xda>
 80485db:	89 cb                	mov    %ecx,%ebx
 80485dd:	e9 3e ff ff ff       	jmp    8048520 <main+0xb0>
 80485e2:	89 d0                	mov    %edx,%eax
 80485e4:	85 c0                	test   %eax,%eax
 80485e6:	74 b9                	je     80485a1 <main+0x131>
 80485e8:	8b 48 04             	mov    0x4(%eax),%ecx
 80485eb:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 80485f2:	eb af                	jmp    80485a3 <main+0x133>
 ...
 804860a:	eb 99                	jmp    80485a5 <main+0x135>
 804860c:	8b 75 e8             	mov    0xffffffe8(%ebp),%esi
 804860f:	85 f6                	test   %esi,%esi
 8048611:	0f 84 43 ff ff ff    	je     804855a <main+0xea>
