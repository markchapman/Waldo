...
mov    0x8(%ebp),%eax
test   %eax,%eax
je     804a825 <sglib_Tree_len+0xc5>
xor    %edi,%edi
xor    %edx,%edx
nop
lea    0x0(%esi),%esi
...
cmp    $0x7f,%edx
mov    0x10(%eax),%eax
jg     804a801 <sglib_Tree_len+0xa1>
test   %eax,%eax
mov    %ecx,0xfffffffc(%esi,%edx,4)
movb   $0x0,0xffffffff(%edx,%ebx,1)
jne    804a790 <sglib_Tree_len+0x30>
nop
lea    0x0(%esi),%esi
sub    $0x1,%edx
...
jle    804a7e9 <sglib_Tree_len+0x89>
mov    0xfffffd74(%ebp,%edx,4),%eax
test   %eax,%eax
je     804a7b0 <sglib_Tree_len+0x50>
movl   $0x0,0xfffffd74(%ebp,%edx,4)
add    $0x1,%edx
jmp    804a780 <sglib_Tree_len+0x20>
mov    0xfffffd74(%ebp,%edx,4),%eax
test   %eax,%eax
jne    804a7d9 <sglib_Tree_len+0x79>
add    $0x29c,%esp
mov    %edi,%eax
pop    %ebx
pop    %esi
...
xor    %edi,%edi
jmp    804a7f4 <sglib_Tree_len+0x94>
lea    0x0(%esi),%esi
