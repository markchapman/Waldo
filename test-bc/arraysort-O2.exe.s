...
./test-b/arraysort-O2.exe:     file format elf32-i386
...
08048410 <main>:
 ...
 80484b0:	8b 85 4c ee ff ff    	mov    0xffffee4c(%ebp),%eax
 80484b6:	29 f8                	sub    %edi,%eax
 80484b8:	83 f8 02             	cmp    $0x2,%eax
 80484bb:	0f 8e bd 00 00 00    	jle    804857e <main+0x16e>
 80484c1:	8b 9d 4c ee ff ff    	mov    0xffffee4c(%ebp),%ebx
 80484c7:	8d 57 01             	lea    0x1(%edi),%edx
 80484ca:	83 eb 01             	sub    $0x1,%ebx
 80484cd:	39 da                	cmp    %ebx,%edx
 80484cf:	7d 4b                	jge    804851c <main+0x10c>
 80484d1:	8b 8c 95 50 ee ff ff 	mov    0xffffee50(%ebp,%edx,4),%ecx
 80484d8:	8d 84 95 50 ee ff ff 	lea    0xffffee50(%ebp,%edx,4),%eax
 80484df:	8b b4 bd 50 ee ff ff 	mov    0xffffee50(%ebp,%edi,4),%esi
 80484e6:	39 f1                	cmp    %esi,%ecx
 80484e8:	7e 14                	jle    80484fe <main+0xee>
 80484ea:	e9 f4 00 00 00       	jmp    80485e3 <main+0x1d3>
 80484ef:	90                   	nop    
 80484f0:	8b 48 04             	mov    0x4(%eax),%ecx
 80484f3:	83 c0 04             	add    $0x4,%eax
 80484f6:	39 ce                	cmp    %ecx,%esi
 80484f8:	0f 8c e5 00 00 00    	jl     80485e3 <main+0x1d3>
 ...
 8048523:	0f 8e f8 00 00 00    	jle    8048621 <main+0x211>
 ...
 804853b:	0f 8d bb 00 00 00    	jge    80485fc <main+0x1ec>
 ...
 8048567:	89 95 4c ee ff ff    	mov    %edx,0xffffee4c(%ebp)
 804856d:	8b 85 4c ee ff ff    	mov    0xffffee4c(%ebp),%eax
 8048573:	29 f8                	sub    %edi,%eax
 8048575:	83 f8 02             	cmp    $0x2,%eax
 8048578:	0f 8f 43 ff ff ff    	jg     80484c1 <main+0xb1>
 804857e:	0f 84 d1 00 00 00    	je     8048655 <main+0x245>
 8048584:	8b 95 48 ee ff ff    	mov    0xffffee48(%ebp),%edx
 804858a:	85 d2                	test   %edx,%edx
 804858c:	0f 8f fd fe ff ff    	jg     804848f <main+0x7f>
 8048592:	8b 85 44 ee ff ff    	mov    0xffffee44(%ebp),%eax
 8048598:	85 c0                	test   %eax,%eax
 804859a:	7e 2a                	jle    80485c6 <main+0x1b6>
 804859c:	bb 01 00 00 00       	mov    $0x1,%ebx
 80485a1:	8d b5 50 ee ff ff    	lea    0xffffee50(%ebp),%esi
 80485a7:	8b 44 9e fc          	mov    0xfffffffc(%esi,%ebx,4),%eax
 80485ab:	83 c3 01             	add    $0x1,%ebx
 80485ae:	c7 04 24 73 87 04 08 	movl   $0x8048773,(%esp)
 80485b5:	89 44 24 04          	mov    %eax,0x4(%esp)
 80485b9:	e8 4e fd ff ff       	call   804830c <printf@plt>
 80485be:	3b 9d 40 ee ff ff    	cmp    0xffffee40(%ebp),%ebx
 80485c4:	75 e1                	jne    80485a7 <main+0x197>
 80485c6:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
 80485cd:	e8 1a fd ff ff       	call   80482ec <putchar@plt>
 80485d2:	81 c4 c8 11 00 00    	add    $0x11c8,%esp
 ...
 80485dd:	5f                   	pop    %edi
 80485de:	5d                   	pop    %ebp
 80485df:	8d 61 fc             	lea    0xfffffffc(%ecx),%esp
 80485e2:	c3                   	ret    
 80485e3:	8b 84 9d 50 ee ff ff 	mov    0xffffee50(%ebp,%ebx,4),%eax
 80485ea:	39 c6                	cmp    %eax,%esi
 80485ec:	7c 02                	jl     80485f0 <main+0x1e0>
 80485ee:	7f 39                	jg     8048629 <main+0x219>
 80485f0:	83 eb 01             	sub    $0x1,%ebx
 80485f3:	39 da                	cmp    %ebx,%edx
 80485f5:	7e ec                	jle    80485e3 <main+0x1d3>
 80485f7:	e9 09 ff ff ff       	jmp    8048505 <main+0xf5>
 80485fc:	8b 8d 48 ee ff ff    	mov    0xffffee48(%ebp),%ecx
 8048602:	89 bc 8d f0 fe ff ff 	mov    %edi,0xfffffef0(%ebp,%ecx,4)
 8048609:	8d 7b 01             	lea    0x1(%ebx),%edi
 804860c:	89 94 8d f0 fd ff ff 	mov    %edx,0xfffffdf0(%ebp,%ecx,4)
 8048613:	83 c1 01             	add    $0x1,%ecx
 8048616:	89 8d 48 ee ff ff    	mov    %ecx,0xffffee48(%ebp)
 804861c:	e9 8f fe ff ff       	jmp    80484b0 <main+0xa0>
 8048621:	8d 7b 01             	lea    0x1(%ebx),%edi
 8048624:	e9 87 fe ff ff       	jmp    80484b0 <main+0xa0>
 8048629:	39 d3                	cmp    %edx,%ebx
 804862b:	7e 1b                	jle    8048648 <main+0x238>
 804862d:	89 84 95 50 ee ff ff 	mov    %eax,0xffffee50(%ebp,%edx,4)
 8048634:	8d 42 02             	lea    0x2(%edx),%eax
 8048637:	39 c3                	cmp    %eax,%ebx
 8048639:	89 8c 9d 50 ee ff ff 	mov    %ecx,0xffffee50(%ebp,%ebx,4)
 8048640:	7e 45                	jle    8048687 <main+0x277>
 8048642:	83 c2 01             	add    $0x1,%edx
 8048645:	83 eb 01             	sub    $0x1,%ebx
 8048648:	39 da                	cmp    %ebx,%edx
 804864a:	0f 8c 81 fe ff ff    	jl     80484d1 <main+0xc1>
 8048650:	e9 c7 fe ff ff       	jmp    804851c <main+0x10c>
 8048655:	8b 85 4c ee ff ff    	mov    0xffffee4c(%ebp),%eax
 804865b:	8b 8c bd 50 ee ff ff 	mov    0xffffee50(%ebp,%edi,4),%ecx
 8048662:	83 e8 01             	sub    $0x1,%eax
 8048665:	8b 94 85 50 ee ff ff 	mov    0xffffee50(%ebp,%eax,4),%edx
 804866c:	39 d1                	cmp    %edx,%ecx
 804866e:	0f 8e 10 ff ff ff    	jle    8048584 <main+0x174>
 8048674:	89 94 bd 50 ee ff ff 	mov    %edx,0xffffee50(%ebp,%edi,4)
 804867b:	89 8c 85 50 ee ff ff 	mov    %ecx,0xffffee50(%ebp,%eax,4)
 8048682:	e9 fd fe ff ff       	jmp    8048584 <main+0x174>
 8048687:	8d 42 01             	lea    0x1(%edx),%eax
 804868a:	39 c3                	cmp    %eax,%ebx
 804868c:	7e ba                	jle    8048648 <main+0x238>
 804868e:	89 c2                	mov    %eax,%edx
 8048690:	eb b6                	jmp    8048648 <main+0x238>
 8048692:	90                   	nop    
 8048693:	90                   	nop    
 8048694:	90                   	nop    
 8048695:	90                   	nop    
